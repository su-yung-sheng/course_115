...
/* ── 概念檢測：自己一組星星 ──────────────────────
  ...
  GATE: {
     ...
     */
    /* ⚠️ 2026-08-17 再加第 10 關（6-3-3 資料大爆炸）：
       它比的是第 8、9 關寫過的那兩支程式的效能，自己不該再寫一支
       —— 原本那支「兩個停止條件」的完整版循序搜尋已搬到第 8 關。
       ⇒ 作品星的滿分因此從 9 關（36）變成 **8 關（32）**。
          分母是現算的（GRADING.moduleMax(關數, 關卡代號)），會自己跟上。 */
    NO_UPLOAD: ['6-1-1', '6-3-3'],
