...
| 🐱 程式設計（Scratch） | `flowchart.html` | 70 | 前導「清單學習機」＋音階教材；排流程圖 → 寫 Scratch |
...
| 課 | 關卡 | 星數 | 一關的組成 | 依序開放 |
|---|---|---|---|---|
| ⚖️ 資訊倫理 | 10 | 30 | 情境 → 選擇題 | 否 |
| 🧠 運算思維 | 10 | 20 | 生活謎題 → 作答 | 否 |
| 🐱 程式設計 | 20 | 70 | 情境 → 問題分析 → **概念檢測 5 題** → 排流程圖 → 寫 Scratch → 上傳 .sb3 | ✅ **是** |
| 💡 智慧家居 | 5 節 | **0** | 見下 | 否（五節可自由進出） |
